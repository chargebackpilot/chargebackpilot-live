    ...
    <MainLayout>
      <div className="container mx-auto max-w-3xl py-16 px-4">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p>Wir nutzen zur Auswertung von Fallbeschreibungen und zur Generierung von Texten die API von Google LLC (Gemini API). Wenn Sie unser Formular nutzen, werden die von Ihnen eingegebenen Inhalte (z. B. Fallbeschreibung, Händlername, Betrag) an Server von Google LLC übertragen. Diese Übermittlung kann in die USA erfolgen.</p>
          <p>Google LLC verarbeitet diese Informationen ausschließlich als technischer Dienstleister für die KI-Auswertung. Wir geben die Daten nicht an weitere Dritte weiter, soweit dies nicht zur Bereitstellung des Dienstes erforderlich ist.</p>
          <p><strong>Rechtsgrundlage:</strong> Die Verarbeitung erfolgt auf Grundlage Ihrer ausdrücklichen Einwilligung (Art. 6 Abs. 1 lit. a DSGVO), die Sie durch das Bestätigen der Checkbox vor der Analyse erteilen.</p>
          <p><strong>Datenvermeidung:</strong> Bitte geben Sie im Textfeld keine sensiblen personenbezogenen Daten ein, wie Passwörter, vollständige IBANs, Ausweisnummern oder Gesundheitsdaten. Laden Sie keine personenbezogenen Anhänge hoch.</p>
          <p><strong>Speicherung:</strong> Die von Ihnen eingegebenen fallbezogenen Informationen werden zum Zweck der Analyse und Bereitstellung des Berichts gespeichert. Soweit keine gesetzliche Aufbewahrungspflicht besteht, können Sie die Löschung Ihrer Daten verlangen.</p>
