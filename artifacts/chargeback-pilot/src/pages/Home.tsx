...
const REVIEW_PROFILES = reviewProfilesData.profiles;
const REVIEW_CHECKED_LABEL = reviewProfilesData.checkedAtLabel;
          ...
          <div className="mt-6 flex justify-center" aria-label="Externe Bewertungsprofile">
            <div className="grid w-full max-w-xl gap-2 sm:grid-cols-2">
              <ReviewProfileBadge
                ...
                mark="PE"
                markClassName="bg-[#0b66c3]"
              />
              <ReviewProfileBadge
                profile={REVIEW_PROFILES.trustpilot}
                mark="★"
                markClassName="bg-[#00b67a]"
              />
            </div>
          </div>
          <p className="mt-2 text-center text-[11px] text-muted-foreground">
            Bewertungsprofile zuletzt geprüft: {REVIEW_CHECKED_LABEL}
          </p>
        </div>
      </section>
