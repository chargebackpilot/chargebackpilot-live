...
export const consentsTable = pgTable(
  "consents",
  {
    ...
    agbVersion: text("agb_version").notNull().default("2026-06-26"),
    widerrufVersion: text("widerruf_version").notNull().default("2026-06-26"),
    datenschutzVersion: text("datenschutz_version").notNull().default("2026-06-26"),
    ipHash: text("ip_hash"),
